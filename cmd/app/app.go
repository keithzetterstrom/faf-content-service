...
import (
	...
	"github.com/keithzetterstrom/faf-content-service/cmd/handlers"
	"github.com/keithzetterstrom/faf-content-service/internal/pkg/data/delivery"
	"github.com/keithzetterstrom/faf-content-service/internal/pkg/data/repository"
	"github.com/keithzetterstrom/faf-content-service/internal/pkg/data/usecase"
	db "github.com/keithzetterstrom/faf-content-service/internal/pkg/repository/postgres"
	faflogger "github.com/keithzetterstrom/faf-content-service/utils/logger"
	"github.com/keithzetterstrom/faf-content-service/utils/must"
...
func Start() Base {
	...
	logger, err := faflogger.NewLogger("faf-content-service")
	must.Must(err)
